...
# Save the model to the desktop as a single file
tf.keras.models.save_model(model, os.path.join(desktop_path, 'YUHmodel.tf'), save_format='tf')

model_bytes = model.to_yaml()
tf.io.write_file("Desktop/model.tf", model_bytes)
