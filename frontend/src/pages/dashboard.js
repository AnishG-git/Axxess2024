        ...
        <div className="w-full flex flex-wrap pt-20">
          ...
          <div className=" w-full lg:w-2/3 px-5 lg:pr-10">
            ...
            <div className="w-full flex flex-wrap pt-5 ">
              <div className="w-1/3 ">
                <div className="mx-2 flex  py-5 rounded-lg flex-wrap bg-indigo-600 items-center justify-center text-white  px-2">Daily Log</div>
              </div>
              <div className="w-1/3 ">
                <div className="mx-2 flex  py-5 rounded-lg flex-wrap bg-blue-600 items-center justify-center text-white  px-2">
                  Hospital Call
              ...
              <div className="w-1/3 ">
                <div className="mx-2 flex  py-5 rounded-lg flex-wrap bg-fuchsia-600 items-center justify-center text-white  px-2">
                  Emergency Call
                  <svg width="20" height="20" viewBox="0 0 42 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
